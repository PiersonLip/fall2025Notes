...
\begin{center}
    Tangent line to \(f(x) at (a, f(a))\)\\
    \(y = f(a) + f'(a)(x-a)\)\\
\end{center}

\begin{center}
        Tangent plane to \(f(x,y) at (a,b (f(a,b)))\)\\
        \(z = f(a,b) + f_x(a,b)(x-a) + f_y(a,b)(y-b)\)
    
\end{center}1- stats.norm.cdf((73.5 - 70)/2.5)

\begin{center} \noindent \textbf{\large For linear Approximations} \end{center}
\begin{list}{-}{}
\item Find Tangent plane
\item Solve for \(L(x,y)\). I.e. solve tangent plane at the point provided
\item if it asked linear approx at \((0,0)\), solve for tangent plane, and then sub in \(f(0,0)\) and take that equation
\end{list}

\subsubsection{Linear approx for \(f(v,t)\)}

\[f(v,t) = f(v_0,t_0) + f_v(v_0,t_0)(v-v_0) + f_y(v_0,t_0)(t-t_0)\]
\[f(20,40) = 28\]
\[f_v(20,40) = \frac{f(50-20) - f(30,20)}{50-30}\]
\[f(50,20) = 36\]
\[f(30,20) = 17\]
\[f_v(40,20) \approx \frac{19}{20}\]

\[f_t(40,20) = \frac{f(40-30) - f(40,10)}{30-10}\]
\[f(40,30) = 31\]
\[f(40,10) = 21\]
\[f_t(40,20) = \frac{10}{20}\]
